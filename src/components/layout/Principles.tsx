...
// import CursorGSAP from "../common/CursorGSAP";

const VisionMissionSection: React.FC<VisionMissionData> = ({
  heading,
  content,
}) => (
  <div className="col-1 justify-center mx-auto flex items-center py-10 max-md:flex-col max-sm:py-5">
    ...
    <div className="child-right w-full px-2 py-4 border border-[#ccc] border-r-2 text-xl max-md:text-center max-md:w-[100%] max-sm:text-sm">
      {content}
    </div>
  </div>
);
